...
a persistence unit "correcionEvaluacionWSrieraPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "correcionEvaluacionWSriera\pom.xml":
...
artifact ("correcionEvaluacionWSriera.war") is already built. You can build
